    ...
    case ZCL_PUBLISH_CALORIFIC_VALUE_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 14u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        issuerEventId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        startTime = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
    ...
    case ZCL_PUBLISH_BLOCK_THRESHOLDS_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 19u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        providerId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        issuerEventId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
    ...
    case ZCL_PUBLISH_TIER_LABELS_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 15u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        providerId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        issuerEventId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
    ...
    case ZCL_PUBLISH_BILLING_PERIOD_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 17u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        providerId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        issuerEventId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
    ...
    case ZCL_PUBLISH_CONSOLIDATED_BILL_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 24u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        providerId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        issuerEventId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
    ...
    case ZCL_PUBLISH_CURRENCY_CONVERSION_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 25u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        providerId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        issuerEventId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
    ...
    case ZCL_CANCEL_TARIFF_COMMAND_ID:
      {
        ...
        if (cmd->bufLen < payloadOffset + 9u) { return EMBER_ZCL_STATUS_MALFORMED_COMMAND; }
        providerId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
        issuerTariffId = emberAfGetInt32u(cmd->buffer, payloadOffset, cmd->bufLen);
        payloadOffset += 4u;
